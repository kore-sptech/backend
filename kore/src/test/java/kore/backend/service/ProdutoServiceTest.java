...
// // Arrange
// Long idExistente = 1L;
// ProdutoDTO dtoAtualizacao = new ProdutoDTO("Monitor", "Monitor 144hz", false,
// 20, null, null, null);
// Produto produtoExistente = new Produto(); // Instância original antes do
// update
...
//
// // Act
// Produto resultado = produtoService.atualizarProduto(idExistente,
// dtoAtualizacao);
//
// // Assert
// assertNotNull(resultado);
...
//
// @Test
// @DisplayName("Deve lançar RecursoNaoEncontradoException ao tentar atualizar
// produto inexistente")
...
//
// // Assert extra: notei que na service está escrito "Usuário não encontrado"
// em
// // vez de "Produto"
