...
// ItemDTO dto = new ItemDTO(LocalDateTime.now(), true, 50.0f,
...
// when(itemRepository.saveAll(anyList())).thenAnswer(invocation ->
// invocation.getArgument(0));
//
// // Act
// List<Item> resultado = itemService.adicionarEstoque(dto, quantidade,
// fkProduto);
//
// // Assert
// assertNotNull(resultado);
// assertEquals(3, resultado.size());
// assertEquals(produtoMock, resultado.get(0).getProduto()); // Verifica se
// vinculou o produto
...
//
// @Test
// @DisplayName("Deve lançar RuntimeException ao tentar adicionar estoque para
// produto inexistente")
...
//
// assertEquals("Produto não encontrado com ID: " + fkProduto,
...
//
// @Test
// @DisplayName("Deve retornar lista de itens quando buscar por ID do produto
// existente")
...
//
// @Test
// @DisplayName("Deve retornar lista vazia quando o Optional de itens vier
// vazio")
...
//
// @Test
// @DisplayName("Deve lançar RecursoNaoEncontradoException ao tentar deletar
// item inexistente")
